...
tips-dataset-70 = As an Atmospheric Technician, try to resist the temptation of making canister bombs for Cascade Operatives, unless you're in a last-ditch scenario. They often lead to large amounts of unnecessary friendly fire!
...
tips-dataset-80 = As a Scientist, you can utilize upgraded versions of machines to increase its effectiveness. This can make certain machines significantly better; expeditionaries will love you if you upgrade their ore processor!
...
tips-dataset-108 = The Trench to the east is botj extremely dangerous and hard to see. Be very weary when exploring the sea floor.
...
tips-dataset-122 = Trieste Port 14 is open source! If there's a change you want to make, or a simple item you want to add, then try contributing to the server. It's not as hard as you'd think it is.
